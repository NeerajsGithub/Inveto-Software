...
Future<void> downloadAndOpenExcelFile(BuildContext context, String userEmail , String storeName ,) async {
  ...
  try {
    if (await Permission.manageExternalStorage.request().isGranted) {
      ...
      if (response.statusCode == 200) {
        ...
        final filePath = '${directory?.path}/${storeName}.xlsx';
  ...
  Future<void> addToRack(String rackId, String productId, String storeId , String quantity) async {
  ...
  Future<void> deleteRack(String rackId, String productId, String storeId , String quantity) async {
